...
<h1 class="text-center" style="color: blue;">Data Barang</h1>
<div class="container">
    <hr>
    <div class="col-md-12">
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col" style="color: black;">Kode Barang</th>
                    <th scope="col" style="color: black;">Nama Barang</th>
                    <th scope="col" style="color: black;">Kategori</th>
                    <th scope="col" style="color: black;">Merk</th>
            ...
            <tbody>
                <?php foreach($data as $item) : ?>
                    <?php $nomor++; ?>
                    <tr>
                        <th scope="row" style="color: blue;"><?php echo $nomor; ?></th>
                        <td style="color: blue;"><?php echo $item['id']; ?></td>
                        <td style="color: blue;"><?php echo $item['kode_brg']; ?></td>
                        <td style="color: blue;"><?php echo $item['nama_brg']; ?></td>
                        <td style="color: blue;"><?php echo $item['kategori']; ?></td>
                        <td style="color: blue;"><?php echo $item['merk']; ?></td>
                        <td style="color: blue;"><?php echo $item['jumlah']; ?></td>
                        <td style="color: blue;">
                            <?php echo "<a href='edit.php?id=$item[id]' style='color: orange;'>Edit</a> | <a href='delete.php?id=$item[id]' style='color: red;'>Delete</a>"; ?>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
